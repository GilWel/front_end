...
// peopleExtended.forEach((humen) => {
//         const newListEtemElement = document.createElement('li');
//         newListEtemElement.textContent = humen.name;
//         AllListElement.append(newListEtemElement);
//     }
// );
